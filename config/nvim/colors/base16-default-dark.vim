...
call <sid>hi("Error",         s:gui00, s:gui08, "none", s:cterm08, "", "")
...
call <sid>hi("Conceal",       s:gui0D, s:gui00, s:cterm0D, "none", "", "")
call <sid>hi("Cursor",        s:gui00, s:gui05, "none", s:cterm05, "", "")
...
call <sid>hi("DiffAdded",    s:gui0B, s:gui00,  s:cterm0B, "none", "", "")
call <sid>hi("DiffFile",     s:gui08, s:gui00,  s:cterm08, "none", "", "")
call <sid>hi("DiffNewFile",  s:gui0B, s:gui00,  s:cterm0B, "none", "", "")
call <sid>hi("DiffLine",     s:gui0D, s:gui00,  s:cterm0D, "none", "", "")
call <sid>hi("DiffRemoved",  s:gui08, s:gui00,  s:cterm08, "none", "", "")
...
call <sid>hi("markdownError",             s:gui05, s:gui00, s:cterm05, "none", "", "")
