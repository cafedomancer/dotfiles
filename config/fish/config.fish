...
if status is-interactive
    ...
    abbr --add --global gbda 'git branch --no-color --merged | command grep -vE "^([+*]|\s*(main|development|develop|devel|dev)\s*\$)" | command xargs -n 1 git branch -d'
    abbr --add --global gbD 'git branch -D'
    ...
    abbr --add --global ggf 'git push --force origin (git symbolic-ref --short HEAD)'
    abbr --add --global ggfl 'git push --force-with-lease origin (git symbolic-ref --short HEAD)'
    abbr --add --global ggl 'git pull origin (git symbolic-ref --short HEAD)'
    abbr --add --global ggp 'git push origin (git symbolic-ref --short HEAD)'
    abbr --add --global ggpnp 'ggl && ggp'
    abbr --add --global ggpull 'git pull origin "(git symbolic-ref --short HEAD)"'
    abbr --add --global ggpur 'ggu'
    abbr --add --global ggpush 'git push origin "(git symbolic-ref --short HEAD)"'
    abbr --add --global ggsup 'git branch --set-upstream-to=origin/(git symbolic-ref --short HEAD)'
    abbr --add --global ggu 'git pull --rebase origin (git symbolic-ref --short HEAD)'
    abbr --add --global gpsup 'git push --set-upstream origin (git symbolic-ref --short HEAD)'
    ...
    abbr --add --global git-svn-dcommit-push 'git svn dcommit && git push github main:svntrunk'
    ...
    abbr --add --global groh 'git reset origin/(git symbolic-ref --short HEAD) --hard'
    ...
    abbr --add --global glum 'git pull upstream main'
