...
if status --is-interactive
    ...
    abbr --add --global rdm 'bin/rake db:migrate'
    abbr --add --global rdms 'bin/rake db:migrate:status'
    abbr --add --global rdmtc 'bin/rake db:migrate db:test:clone'
    abbr --add --global rdr 'bin/rake db:rollback'
    abbr --add --global rdc 'bin/rake db:create'
    abbr --add --global rds 'bin/rake db:seed'
    abbr --add --global rdd 'bin/rake db:drop'
    abbr --add --global rdrs 'bin/rake db:reset'
    abbr --add --global rdtc 'bin/rake db:test:clone'
    abbr --add --global rdtp 'bin/rake db:test:prepare'
    abbr --add --global rdsl 'bin/rake db:schema:load'
    abbr --add --global rlc 'bin/rake log:clear'
    abbr --add --global rn 'bin/rake notes'
    abbr --add --global rr 'bin/rake routes'
    abbr --add --global rrg 'bin/rake routes | grep'
    abbr --add --global rt 'bin/rake test'
    abbr --add --global rmd 'bin/rake middleware'
    abbr --add --global rsts 'bin/rake stats'
