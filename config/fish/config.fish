...
if status --is-interactive
    ...
    abbr --add --global ggf 'git push --force origin $(current_branch)'
    abbr --add --global ggfl 'git push --force-with-lease origin $(current_branch)'
    abbr --add --global ggl 'git pull origin $(current_branch)'
    abbr --add --global ggp 'git push origin $(current_branch)'
    ...
    abbr --add --global ggu 'git pull --rebase origin $(current_branch)'
    ...
    abbr --add --global rc 'rails console'
    abbr --add --global rcs 'rails console --sandbox'
    abbr --add --global rd 'rails destroy'
    abbr --add --global rdb 'rails dbconsole'
    abbr --add --global rgen 'rails generate'
    abbr --add --global rgm 'rails generate migration'
    abbr --add --global rp 'rails plugin'
    abbr --add --global ru 'rails runner'
    abbr --add --global rs 'rails server'
    abbr --add --global rsd 'rails server --debugger'
    abbr --add --global rsp 'rails server --port'

    abbr --add --global rdm 'rake db:migrate'
    abbr --add --global rdms 'rake db:migrate:status'
    abbr --add --global rdmtc 'rake db:migrate db:test:clone'
    abbr --add --global rdr 'rake db:rollback'
    abbr --add --global rdc 'rake db:create'
    abbr --add --global rds 'rake db:seed'
    abbr --add --global rdd 'rake db:drop'
    abbr --add --global rdrs 'rake db:reset'
    abbr --add --global rdtc 'rake db:test:clone'
    abbr --add --global rdtp 'rake db:test:prepare'
    abbr --add --global rdsl 'rake db:schema:load'
    abbr --add --global rlc 'rake log:clear'
    abbr --add --global rn 'rake notes'
    abbr --add --global rr 'rake routes'
    abbr --add --global rrg 'rake routes | grep'
    abbr --add --global rt 'rake test'
    abbr --add --global rmd 'rake middleware'
    abbr --add --global rsts 'rake stats'
